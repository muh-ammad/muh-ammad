...
export class DiplomeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.diplomeService
      ...
      .subscribe(
        (res: HttpResponse<IDiplome[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDiplomes(): void {
    this.eventSubscriber = this.eventManager.subscribe('diplomeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDiplome[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
