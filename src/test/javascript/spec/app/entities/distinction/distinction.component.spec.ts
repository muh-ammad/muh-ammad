...
import { DistinctionComponent } from 'app/entities/distinction/distinction.component';
...
describe('Component Tests', () => {
  describe('Distinction Management Component', () => {
    let comp: DistinctionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DistinctionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.distinctions && comp.distinctions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
