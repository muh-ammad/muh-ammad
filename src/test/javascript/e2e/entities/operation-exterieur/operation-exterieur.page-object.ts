...
export class OperationExterieurComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-operation-exterieur div table .btn-danger'));
  title = element.all(by.css('jhi-operation-exterieur div h2#page-heading span')).first();
...
export class OperationExterieurUpdatePage {
  pageTitle = element(by.id('jhi-operation-exterieur-heading'));
...
export class OperationExterieurDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-operationExterieur-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-operationExterieur'));
